...
if page == pages[2] :
  ...
  sns.lineplot(x='year', y='temperature_change_from_ghg', data=df_world, ax=ax, label='Gaz à effet de serre (GHG)')
  sns.lineplot(x='year', y='temperature_change_from_ch4', data=df_world, ax=ax, label='Méthane (CH4)')
  sns.lineplot(x='year', y='temperature_change_from_co2', data=df_world, ax=ax, label='Dioxyde de carbone (CO2)')
  sns.lineplot(x='year', y='temperature_change_from_n2o', data=df_world, ax=ax, label='Protoxyde d\'azote (N2O)')
